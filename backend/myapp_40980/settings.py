"""
Django settings for myapp_40980 project.
...
WSGI_APPLICATION = 'myapp_40980.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "myapp_40980 API",
    "DESCRIPTION": "API documentation for myapp_40980 App",
    "VERSION": "v1",
}
